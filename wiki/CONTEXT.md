...
4. Check concepts/ for cross-cutting patterns (singleton architecture, API design, external logic model)
...
## Stats
Compiled: 2026-05-16 | Topics: 11 | Concepts: 3 | Sources: 42 | Auto-updates on session start
