...
void loadSettings()
{
    ...
    SHOW_WEATHER = Settings.getBool("WEA", false);
...
void saveSettings()
{
    ...
    Settings.putBool("WEA", SHOW_WEATHER);
...
String OPENWEATHER_LAT = "";
String OPENWEATHER_LON = "";
String OPENWEATHER_UNITS = "";
uint32_t OPENWEATHER_INTERVAL = 600;
int WEATHER_CODE = 0;
String WEATHER_TEMP = "";
String WEATHER_HUM = "";
String WEATHER_CONDITION = "";
bool WEATHER_READY = false;
unsigned long WEATHER_UPDATED = 0;
