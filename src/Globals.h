...
extern String OPENWEATHER_API_KEY;
extern String OPENWEATHER_LAT;
extern String OPENWEATHER_LON;
extern String OPENWEATHER_UNITS;
extern uint32_t OPENWEATHER_INTERVAL;
...
extern unsigned long WEATHER_UPDATED;
extern String WEATHER_ERROR;
